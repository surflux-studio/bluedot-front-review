import{i as l}from"./store.BuEJqzLV.js";import{K as y}from"./index.eXkzb036.js";const i={listeners:{},addListener:(e,r)=>{if(i.listeners[e]||(i.listeners[e]=[]),i.listeners[e].push(r),!window.mockKeyboard){const o=document.createElement("div");o.setAttribute("data-mock-keyboard",""),o.style.cssText=`
        position: fixed;
        bottom: -300px;
        left: 0;
        right: 0;
